...
if(D.funnel){
  ...
  if(pFirst&&pLast&&pLast.pbaP-pFirst.pbaP>=3) flags.push({s:'amber',t:`<b>Current PBA climbing:</b> ${pFirst.pbaP.toFixed(1)}% of FTDs in ${pFirst.m} → ${pLast.pbaP.toFixed(1)}% in ${pLast.m} (official ThoughtSpot series) — freeloader share rising steadily all year.`});
