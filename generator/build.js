...
if(D.funnel){
  ...
  const chRows=chR.map(r=>({cells:[r.ch, num(r.f), num(r.apd2), pct1(r.apdP/100), r.apd0!=null?num(r.apd0):'—', r.apd0!=null?pillHi(r.apd0/r.f*100,6,8):'—', r.apd1!=null?num(r.apd1):'—', r.apd1!=null?pillHi(r.apd1/r.f*100,30,35):'—', num(r.pp8), `<span class="pill ${r.ppP>=ppB?'green':r.ppP>=ppB*0.75?'amber':'red'}">${r.ppP.toFixed(1)}%</span>`, r.avgpp.toFixed(2), div(r.pn,r.fm)?gbp(div(r.pn,r.fm)):'—']}));
