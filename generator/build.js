...
if(D.revshare){
  const _rvA=D.revshare.rows.concat(D.revshare.jul?[D.revshare.jul]:[]); EMBED.revshare={ m:_rvA.map(r=>r.m), ltv15:_rvA.map(r=>+r.ltv15.toFixed(3)), ltv10:_rvA.map(r=>+r.ltv10.toFixed(3)), a15:_rvA.map(r=>+r.affltv15.toFixed(3)), a10:_rvA.map(r=>+r.affltv10.toFixed(3)) };
  ...
  if(R.jul) rvr.push({cells:['Jul MTD*', gbpM(R.jul.sp), gbpM(R.jul.net15), gbpM(R.jul.net10), pill(R.jul.ltv15), pill(R.jul.ltv10), dlt(R.jul.ltv15,R.jul.ltv10), pill(R.jul.affltv15), pill(R.jul.affltv10)]});
